...
export const metadata: Metadata = {
  ...
  description: "How well do you know Iosco County? Try ten multiple-choice history questions and discover the stories behind the answers.",
...
export default function HistoryQuizPage() {
  return <><Header /><main className="quiz-page"><div className="container quiz-page__inner">
    <header className="quiz-page__intro"><div><p className="eyebrow">Iosco County history quiz</p><h1>How well do you know Iosco County?</h1><p>Ten questions. A little local history with every answer. No time limit.</p></div><img src="/images/iosco-museum-main.svg" alt="The museum’s historic home in East Tawas" width={180} height={150} /></header>
    <HistoryQuiz />
